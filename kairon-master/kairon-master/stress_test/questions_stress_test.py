...
class ExecuteTask(SequentialTaskSet):
    ...
    locust -f stress_test/questions_stress_test.py --headless -u 1000 -r 100 --host=http://23.251.147.214:8000
    u: number of users
    ...
    To run from UI:
    locust -f stress_test/questions_stress_test.py -u 1000 -r 100 --host=http://23.251.147.214:8000
    """
