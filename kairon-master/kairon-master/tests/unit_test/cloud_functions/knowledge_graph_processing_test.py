...
def test_knowledge_graph_processing():
    responses.add(
        ...
        url="http://23.251.147.214:5000/api/bot/processing-status",
        body="Status updated successfully",
        status=200
    )
    ecs = client('ecs', region_name="us-east-1")
    ecs.create_cluster(
        clusterName='KGCluster',
        tags=[
            {
                'key': 'Cost',
                'value': 'AI'
    ...
    os.environ['CLUSTER'] = "arn:aws:ecs:us-east-1:012345678910:cluster/KGCluster"
    ...
    request = {
        ...
        'httpMethod': 'POST', 'path': '/knowledge-graph', 'queryStringParameters': {},
        'headers': {'accept': '*/*', 'accept-encoding': 'gzip, deflate', 'accept-language': 'en-US,en;q=0.5',
                    ...
                    'x-amzn-trace-id': 'Root=1-5f740d25-7880bfe721e19cf91613f209', 'x-forwarded-for': '103.203.145.3',
                    'x-forwarded-port': '80', 'x-forwarded-proto': 'http'},
        'body': '{ "bot": "5f64a80453cb9f7074054c62",  "user": "udit", "kairon_url":"http://23.251.147.214:5000", "token":"demo_token"}',
        'isBase64Encoded': False}
    response = training_data_generator.lambda_handler(request,{})
