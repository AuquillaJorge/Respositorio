...
class TestEventDefinitions:
    ...
    def test_data_importer_enqueue(self):
        ...
        url = f"http://23.251.147.214:5001/api/events/execute/{EventClass.data_importer}"
        responses.add(
            "POST", url,
    ...
    def test_faq_importer_enqueue(self):
        ...
        url = f"http://23.251.147.214:5001/api/events/execute/{EventClass.faq_importer}"
        responses.add(
            "POST", url,
            json={"message": "Success", "success": True, "error_code": 0, "data": {
                'StatusCode': 200,
    ...
    def test_model_training_enqueue(self, monkeypatch):
        bot = 'test_definitions'
        user = 'test_user'
        url = f"http://23.251.147.214:5001/api/events/execute/{EventClass.model_training}"
        responses.add(
            "POST", url,
            json={"message": "Success", "success": True, "error_code": 0, "data": {
                'StatusCode': 200,
    ...
    def test_model_training_enqueue_event_server_failure(self, monkeypatch):
        ...
        monkeypatch.setattr(AccountProcessor, "get_bot", __mock_get_bot)
        responses.add(
            "POST", f"http://23.251.147.214:5001/api/events/execute/{EventClass.model_training}",
            json={"message": "Failed", "success": False, "error_code": 400, "data": None}
        )
    ...
    def test_model_testing_enqueue(self):
        bot = 'test_definitions'
        user = 'test_user'
        url = f"http://23.251.147.214:5001/api/events/execute/{EventClass.model_testing}"
        responses.add(
            "POST", url,
            json={"message": "Success", "success": True, "error_code": 0, "data": {
                'StatusCode': 200,
    ...
    def test_model_testing_enqueue_event_server_failure(self):
        ...
        user = 'test_user'
        responses.add(
            "POST", f"http://23.251.147.214:5001/api/events/execute/{EventClass.model_testing}",
            json={"message": "Failed", "success": False, "error_code": 400, "data": None}
        )
    ...
    def test_delete_history_presteps_validate_endpoint(self):
        ...
        history_endpoint = EndPointHistory(url="http://23.251.147.214:10000")
    ...
    def test_delete_history_enqueue(self):
        ...
        bot = 'test_definitions'
        user = 'test_user'
        url = f"http://23.251.147.214:5001/api/events/execute/{EventClass.delete_history}"
        responses.add(
            "POST", url,
            json={"message": "Success", "success": True, "error_code": 0, "data": {
                'StatusCode': 200,
