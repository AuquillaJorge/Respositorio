...
class TestAccountProcessor:
    ...
    def test_authenticate_method(self):
        ...
        password = "Welcome@15"
        access_token, access_token_expiry, new_refresh_token, refresh_token_expiry = Authentication.authenticate(username, password)
    ...
    async def test_get_redirect_url_google(self, monkeypatch):
        discovery_url = 'https://discovery.url.23.251.147.214/o/oauth2/v2/auth?response_type=code&client_id'
    ...
    async def test_sso_linkedin_login_error(self, httpx_mock: HTTPXMock):
        httpx_mock.add_response(
            ...
            data={
                ...
                "redirect_uri": "http://23.251.147.214:8080/callback/linkedin",
                "client_secret": "qwertyuiopasdf"
            },
            json={'access_token': '1234567890'},
            match_content=b"grant_type=authorization_code&client_id=asdfghjklzxcvb&code=4%2F0AX4XfWh-AOKSPocewBBm0KAE_5j1qGNNWJAdbRcZ8OYKUU1KlwGqx_kOz6yzlZN-jUBi0Q&redirect_uri=http%3A%2F%2F23.251.147.214%3A8080%2Fcallback%2Flinkedin&client_secret=qwertyuiopasdf",
        )
        httpx_mock.add_response(
