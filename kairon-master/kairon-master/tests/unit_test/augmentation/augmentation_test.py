...
class TestCli:
    ...
    def test_parse_document_and_generate_training_data_failure(self, monkeypatch):
        ...
        responses.add(
            responses.PUT,
            "http://23.251.147.214:5000/api/bot/update/data/generator/status",
            status=200,
        ...
        parse_document_and_generate_training_data("http://23.251.147.214:5000", "testUser", "testtoken")
    ...
    def test_parse_document_and_generate_training_data_no_doc_path(self, monkeypatch):
        ...
        responses.add(
            responses.GET,
            "http://23.251.147.214:5000/api/bot/data/generation/latest",
            status=200,
            json={"success":True, "data":None, "message":None, "error_code":0}
        )
        parse_document_and_generate_training_data("http://23.251.147.214:5000", "testUser", "testtoken")
    ...
    def test_fetch_latest_data_generator_status(self, monkeypatch):
        ...
        resp = TrainingDataGeneratorUtil.fetch_latest_data_generator_status("http://23.251.147.214:5000", "testUser",
                                                                            "testtoken")
    ...
    def test_set_training_data_status(self, monkeypatch):
        ...
        TrainingDataGeneratorUtil.set_training_data_status("http://23.251.147.214:5000",
